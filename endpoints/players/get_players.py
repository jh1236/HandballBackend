...
from endpoints.players.blueprint import players
...
def get_players():
    ...
    players = q.join(People, PlayerGameStats.player_id == People.id).group_by(PlayerGameStats.player_id).order_by(
